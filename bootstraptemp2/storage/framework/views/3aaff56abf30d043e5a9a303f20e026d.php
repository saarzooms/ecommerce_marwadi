  <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href = "charts"><i class="ti-bar-chart-alt"></i> Charts <span
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Table <span
                        ...
                        <ul>    
                      <li>
                            <li><a href="table">Datatable Row Select</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="form"><i class="ti-view-list-alt"></i> Basic Form </a></li>
    ...
    </div><?php /**PATH C:\xampp\htdocs\Internship2023\ecommerce_marwadi\bootstraptemp2\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>