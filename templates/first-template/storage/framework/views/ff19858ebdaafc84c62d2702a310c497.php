...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(url('img/apple-icon.png')); ?>">
  ...
  <!-- Nucleo Icons -->
  <link href="<?php echo e(url('css/nucleo-icons.css')); ?>" rel="stylesheet" />
  <link href="<?php echo e(url('css/nucleo-svg.css')); ?>" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="<?php echo e(url('css/nucleo-svg.css')); ?>" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="<?php echo e(url('css/soft-ui-dashboard.css?v=1.0.7')); ?>" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100 virtual-reality">
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="<?php echo e(url('/img/team-2.jpg')); ?>" class="avatar avatar-sm  me-3 ">
                      </div>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="<?php echo e(url('img/small-logos/logo-spotify.svg')); ?>" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
  ...
  <div class="border-radius-xl mt-3 mx-3 position-relative" style="background-image: <?php echo e(url('img/vr-bg.jpg')); ?> ; background-size: cover;">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
          <img src="<?php echo e(url('img/logo-ct-dark.png')); ?>" class="navbar-brand-img h-100" alt="main_logo">
      ...
      <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
          <div class="full-background" style="background-image: <?php echo e(url('img/curved-images/white-curved.jpg')); ?>"></div>
          ...
          <div class="row pt-10">
            <div class="col-lg-1 col-md-1 pt-5 pt-lg-0 ms-lg-5 text-center">
              <a href="javascript:;" class="avatar avatar-md border-0" data-bs-toggle="tooltip" data-bs-placement="left" title="My Profile">
                <img class="border-radius-lg" alt="Image placeholder" src="<?php echo e(url('img/team-1.jpg')); ?>">
              </a>
            ...
            <div class="col-lg-8 col-md-11">
              <div class="d-flex">
                ...
                <div class="ms-auto">
                  <img class="w-50 float-end mt-lg-n4" src="<?php echo e(url('img/small-logos/icon-sun-cloud.png')); ?>" alt="image sun">
                </div>
              </div>
              <div class="row mt-4">
                ...
                <div class="col-lg-4 col-md-4 mt-4 mt-sm-0">
                  <div class="card card-background card-background-mask-primary move-on-hover align-items-start">
                    <div class="cursor-pointer">
                      <div class="full-background" style="background-image: <?php echo e(url('img/curved-images/curved1.jpg')); ?>"></div>
                      <div class="card-body">
                        ...
                        <div class="ms-auto">
                          <div class="avatar-group">
                            <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="2 New Messages">
                              <img alt="Image placeholder" src="<?php echo e(url('img/team-1.jpg')); ?>">
                            </a>
                            <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="1 New Message">
                              <img alt="Image placeholder" src="<?php echo e(url('img/team-2.jpg')); ?>">
                            </a>
                            <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="13 New Messages">
                              <img alt="Image placeholder" src="<?php echo e(url('img/team-3.jpg')); ?>">
                            </a>
                            <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="7 New Messages">
                              <img alt="Image placeholder" src="<?php echo e(url('img/team-4.jpg')); ?>">
                            </a>
                          </div>
                        </div>
                      </div>
  ...
  <script src="<?php echo e(url('js/plugins/perfect-scrollbar.min.js')); ?>"></script>
  <script src="<?php echo e(url('js/plugins/smooth-scrollbar.min.js')); ?>"></script>
  <script>
  ...
  <script src="<?php echo e(url('js/soft-ui-dashboard.min.js?v=1.0.7')); ?>"></script>
</body>

</html><?php /**PATH D:\internship\laravel\first-template\resources\views/front-end/virtual-reality.blade.php ENDPATH**/ ?>