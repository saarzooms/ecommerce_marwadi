...
<script>
  $(function () {
    ...
    // Generate buttons for each row in the table
    $(document).ready(function() {
      $('#example1 tbody tr').each(function() {
        ...
        var actionsColumn = $(this).find('td:last-child');
...
<?php /**PATH C:\xampp\htdocs\Internship2023\ecommerce_marwadi\shop\resources\views/admin/product.blade.php ENDPATH**/ ?>